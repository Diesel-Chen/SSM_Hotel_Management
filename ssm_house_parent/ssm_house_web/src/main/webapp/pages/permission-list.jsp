...
<body class="hold-transition skin-blue sidebar-mini">
	...
	<div class="wrapper">
		...
		<!-- 页面头部 -->
		<jsp:include page="/pages/admin_header.jsp"></jsp:include>
		<!-- 页面头部 /-->

		<!-- 导航侧栏 -->
		<jsp:include page="/pages/admin_aside.jsp"></jsp:include>
		<!-- 导航侧栏 /-->
									...
									<c:forEach items="${permissionList}" var="p">
										<tr>
											...
											<td class="text-center">
												<a href="${pageContext.request.contextPath}/permission/delete?id=${p.id}" class="btn bg-olive btn-xs">删除</a>
											</td>
										</tr>
									</c:forEach>
								</tbody>
