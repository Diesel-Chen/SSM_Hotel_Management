    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="${pageContext.request.contextPath}/house/findDirty">客房清洁打扫</a></li>
                <li class="active">客房打扫</li>
            </ol>
        </section>
        <!-- 内容头部 /-->
                        ...
                        <c:forEach items="${houseList}" var="h">
                            ...
                            <c:if test="${h.houseState eq '脏房' }">
                                <div class="syfj" style="background-image: linear-gradient(to right, #aaa,#fff);">
                                    <span class="s1">${h.houseNum }</span><span class="s2">${h.houseName }<a href="${pageContext.request.contextPath}/house/updateToVacant?hid=${h.hid}"><br>打扫完成</a></span>
                                </div>
                            </c:if>
