        ...
        <section class="content">
            ...
            <div class="bbody">
                <div class="bbleft">
                    <div class="daohang">
                        <ul>
                            <li><a href="${pageContext.request.contextPath}/house/findAllHouse">所有房间</a></li>
                            <li><a href="${pageContext.request.contextPath}/house/findByHouseName?houseName=单人间">单人间</a></li>
                            <li><a href="${pageContext.request.contextPath}/house/findByHouseName?houseName=标准间">标准间</a></li>
                            <li><a href="${pageContext.request.contextPath}/house/findByHouseName?houseName=大床房">大床房</a></li>
                            <li><a href="${pageContext.request.contextPath}/house/findByHouseName?houseName=套间">套间</a></li>
                            <li><a href="${pageContext.request.contextPath}/house/findByHouseName?houseName=总统套房">总统套房</a></li>
                        </ul>
                    </div>
                    <div class="fdata">
                        <c:forEach items="${houseList}" var="h">
                            <c:if test="${h.houseState eq '空房' }">
                                <div class="syfj" style="background-image: linear-gradient(to right, rgb(114,181,254),#fff);">
                                    <span class="s1">${h.houseNum }</span><span class="s2">${h.houseName }<a href="${pageContext.request.contextPath}/house/getHid?hid=${h.hid}"><br>办理入住</a></span>
                                </div>
                            </c:if>
                ...
                <div class="bbright">
                    <form action="${pageContext.request.contextPath}/house/findByHouseState" method="post" >
                        <span>房间状态：</span>
                        <div class="fanghao">
                            房号：<input type="text" name="houseNum">
                        </div>
                        <div class="state">
                            状态：<select name="houseState">
                            <option>--请选择--</option>
                    ...
                    <div class="fxzt">
                        <li><div class="fangzt"><span>全部房态</span></div><div class="fangsl">${houseCount.allHouseCount}间</div></li>
                        <li><div class="fangzt fangzt1"><span>空房</span></div><div class="fangsl">${houseCount.vacantCount} 间</div></li>
                        <li><div class="fangzt fangzt3"><span>预订</span></div><div class="fangsl">${houseCount.preserveCount} 间</div></li>
                        <li><div class="fangzt fangzt4"><span>住人</span></div><div class="fangsl">${houseCount.peopleCount} 间</div></li>
                        <li><div class="fangzt fangzt2"><span>脏房</span></div><div class="fangsl">${houseCount.dirtyCount} 间</div></li>
                    </div>
                </div>
            </div>
        </section>
