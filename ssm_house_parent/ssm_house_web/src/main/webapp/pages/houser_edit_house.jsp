    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="${pageContext.request.contextPath}/pages/admin_add_member.jsp">客房信息管理</a></li>
                <li class="active">客房信息修改</li>
            </ol>
        </section>
        <!-- 内容头部 /-->
        <section class="content">

            <form action="${pageContext.request.contextPath}/house/edit" method="post">
                <div class="panel panel-default mytab">
                    <div class="panel-heading">修改客房信息</div>
                    <div class="row data-type">
                        <input type="hidden" name="hid" value="${house.hid}">
                        <div class="col-md-2 title">房间号</div>
                        <div class="col-md-10 data text">
                            <input type="text" name="houseNum" value="${house.houseNum}">
                        </div>
                        ...
                        <div class="col-md-10 data text">
                            <input type="text" name="houseState"value="${house.houseState}" >
                        </div>

                        <div class="col-md-2 title">房间价格:</div>
                        <div class="col-md-10 data text">
                            <input type="text" name="housePrice" value="${house.housePrice}" >
                        </div>
