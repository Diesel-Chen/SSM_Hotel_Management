        ...
        <section class="content">
            ...
            <div class="col-lg-3 col-xs-6">
                ...
                <div class="small-box bg-aqua">
                    ...
                    <a href="${pageContext.request.contextPath}/order/findReserveByPage?page=1&size=4" class="small-box-footer">详细 <i class="fa fa-arrow-circle-right"></i></a>
                </div>
            </div>
            <!-- ./col -->
            <div class="col-lg-3 col-xs-6">
                ...
                <div class="small-box bg-green">
                    ...
                    <a href="${pageContext.request.contextPath}/house/findAllHouse" class="small-box-footer">详细 <i class="fa fa-arrow-circle-right"></i></a>
                </div>
            </div>
