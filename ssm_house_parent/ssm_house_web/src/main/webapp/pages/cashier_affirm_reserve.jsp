    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="${pageContext.request.contextPath}/order/findAllByPage2">前台收银管理</a></li>
                <li class="active">确认预定</li>
            </ol>
        </section>
        <!-- 内容头部 /-->
                ...
                <div class="box box-primary">
                            ...
                            <table id="dataList" class="table table-bordered table-striped table-hover dataTable">
                                ...
                                <c:forEach items="${pageInfo.list}" var="order" varStatus="state">
                                    ...
                                    <tr>
                                        ...
                                        <td>${(pageInfo.pageNum-1)*pageInfo.pageSize+state.index+1}</td>
                                        ...
                                        <td class="text-center zjxg">
                                            ...
                                            <c:if test="${order.orderStatus == '待处理'}">
                                                <div class="queren" style="background: blue;"><a href="${pageContext.request.contextPath}/order/updateToReserveById?id=${order.oid}">确认预订</a></div>
                                            ...
                                            <c:if test="${order.orderStatus == '已预订'}">
                                                ...
                                                <div class="quxiao" style="background: red;"><a href="${pageContext.request.contextPath}/order/updateToCancelById?id=${order.oid}">取消预订</a></div>
                                            </c:if>
                    ...
                    <div class="box-footer">
                        ...
                        <div class="box-tools pull-right">
                            <ul class="pagination">
                                <li>
                                    <a href="${pageContext.request.contextPath}/order/findAllByPage2?page=1&size=${pageInfo.pageSize}" aria-label="Previous">首页</a>
                                </li>
                                <li><a href="${pageContext.request.contextPath}/order/findAllByPage2?page=${pageInfo.pageNum-1}&size=${pageInfo.pageSize}">上一页</a></li>
                                <c:forEach begin="1" var="i" end="${pageInfo.pages}">

                                    <li class="curPage"><a href="${pageContext.request.contextPath}/order/findAllByPage2?page=${i}&size=${pageInfo.pageSize}">${i}</a></li>

                                </c:forEach>
                                <li><a href="${pageContext.request.contextPath}/order/findAllByPage2?page=${pageInfo.pageNum+1}&size=${pageInfo.pageSize}">下一页</a></li>
                                <li>
                                    <a href="${pageContext.request.contextPath}/order/findAllByPage2?page=${pageInfo.pages}&size=${pageInfo.pageSize}" aria-label="Next">尾页</a>
                                </li>
                            </ul>
                        </div>
...
<script>
    ...
    function changePageSize(){
        ...
        //向服务器发送请求，改变每页显示条数
        location.href="${pageContext.request.contextPath}/order/findAllByPage2?page=1&size="+pageSize;
    }
