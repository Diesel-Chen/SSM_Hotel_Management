...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <form action="${pageContext.request.contextPath}/house/findById2" method="post">
                <input type="hidden" value="${hid}" name="hid">
                <div class="panel panel-default mytab">
                    <div class="panel-heading">入住办理</div>
                    <div class="row data-type">
                        <div class="col-md-2 title">入住时间:</div>

                        <div class="col-md-10 data line-height36">
                                <div class="form-group riqi1" >
                                    <div class="input-group date">
                                        <div class="input-group-addon">
                                            <i class="fa fa-calendar"></i>
                                        </div>
                                        <input type="text" class="form-control pull-right" id="datepicker1" name="comeTime">
                                    </div>
                                    <!-- /.input group -->
                        </div>
                        </div>
                        <div class="col-md-2 title">离店时间:</div>
                        <div class="col-md-10 data line-height36">
                            <div class="form-group riqi1">
                                <div class="input-group date">
                                    <div class="input-group-addon">
